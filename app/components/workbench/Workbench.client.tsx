        ...
        >
          <div
            className={classNames(
              'fixed top-[56px] border-t border-b border-[#4B525B] bottom-2.5  w-[var(--workbench-inner-width)] mr-4 z-0 transition-[left,width] duration-200 bolt-ease-cubic-bezier',
              {
