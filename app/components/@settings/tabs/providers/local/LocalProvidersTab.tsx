  ...
  const ModelDetails = ({ model }: { model: OllamaModel }) => (
    <div className="flex items-center gap-3 text-xs text-bolt-elements-textSecondary">
      <div className="flex items-center gap-1">
        <div className="i-ph:code text-orange-500 dark:text-teal-500" />
        <span>{model.digest.substring(0, 7)}</span>
      </div>
      {model.details && (
        <>
          <div className="flex items-center gap-1">
            <div className="i-ph:database text-orange-500 dark:text-teal-500" />
            <span>{model.details.parameter_size}</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="i-ph:cube text-orange-500 dark:text-teal-500" />
    ...
    <div className="flex items-center gap-2">
      <motion.button
        ...
        className={classNames(
          'rounded-lg p-2',
          'dark:bg-teal-500/10 bg-orange-500/10 dark:text-teal-500 text-orange-500',
          'dark:hover:bg-teal-500/20 hover:bg-orange-500/20',
                ...
                <div className="flex items-start gap-4">
                  <motion.div
                    className={classNames(
                      ...
                      provider.settings.enabled ? 'dark:text-teal-500 text-orange-500' : 'text-bolt-elements-textSecondary',
                    )}
                      ...
                      {editingProvider === provider.name ? (
                        <input
                          ...
                          className={classNames(
                            ...
                            'focus:outline-none focus:ring-2 dark:focus:ring-teal-500/30 focus:ring-orange-500/30',
                            'transition-all duration-200',
                          )}
                          onKeyDown={(e) => {
                            if (e.key === 'Enter') {
                        ...
                        <div
                          ...
                          className={classNames(
                            ...
                            'bg-bolt-elements-background-depth-3 border border-bolt-elements-borderColor',
                            'dark:hover:border-teal-500/30 hover:border-orange-500/30 hover:bg-bolt-elements-background-depth-4',
                            'transition-all duration-200',
                          )}
                        >
              ...
              {provider.settings.enabled && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="i-ph:cube-duotone text-orange-500 dark:text-teal-500" />
                      ...
                      <div className="text-center py-8 text-bolt-elements-textSecondary">
                        ...
                        <p className="text-sm text-bolt-elements-textTertiary px-1">
                          ...
                          <a
                            ...
                            className="dark:text-teal-500 text-orange-500 hover:underline inline-flex items-center gap-0.5 text-base font-medium"
                          >
                            ollama.com/library
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex gap-1">
                            ...
                            {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                              <span className="px-2 py-0.5 text-xs rounded-full dark:bg-teal-500/10 dark:text-teal-500 text-orange-500 bg-teal-orange/10">
                                Configurable
                              </span>
                            )}
                          </div>
